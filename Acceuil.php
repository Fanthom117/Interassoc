...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <title>Interassos courtmetrash - Acceuil</title>
				...
				<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
					...
					<ul class="navbar-nav">
						<li class="nav-item active">
							<a class="nav-link" href="http://127.0.0.1/Projet/resources/views/Acceuil.php">Acceuil<span class="sr-only">(current)</span></a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="http://127.0.0.1/Projet/resources/views/Activites.php">Activités</a>
						</li>
						<li class="nav-item">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md"><br></br>
					...
					<img src="..\medias\sky.jpg" class="rounded"><br></br>
